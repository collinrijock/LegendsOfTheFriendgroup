...
import { P as Phaser$1, c as commonjsGlobal$1, g as getAugmentedNamespace, p as phaserExports } from "./phaser-DsusO_8l.js";
(function polyfill() {
  ...
  (function(global2, factory) {
    ...
    const _TypeContext = class _TypeContext {
      ...
      discoverTypes(klass, parentType, parentIndex, parentHasViewTag) {
        ...
        (_a3 = _TypeContext.inheritedTypes.get(klass)) == null ? void 0 : _a3.forEach((child) => {
...
Schema instances may only have up to 64 fields.`);
      ...
      hasViewTagAtIndex(metadata, index) {
        var _a3;
        return (_a3 = metadata == null ? void 0 : metadata[$viewFieldIndexes]) == null ? void 0 : _a3.includes(index);
      }
    };
    ...
    function deleteOperationAtIndex(changeSet, index) {
      ...
      if (operationsIndex === void 0) {
        ...
        index = (_a3 = Object.entries(changeSet.indexes).find(([_, value]) => value === operationsIndex)) == null ? void 0 : _a3[0];
      }
    ...
    class ChangeTree {
      ...
      setRoot(root) {
        ...
        if (metadata) {
          (_a3 = metadata[$refTypeFieldIndexes]) == null ? void 0 : _a3.forEach((index) => {
            var _a4;
            const field = metadata[index];
            const changeTree = (_a4 = this.ref[field.name]) == null ? void 0 : _a4[$changes];
            if (changeTree) {
      ...
      change(index, operation = exports2.OPERATION.ADD) {
        var _a3;
        const metadata = this.ref.constructor[Symbol.metadata];
        const isFiltered = this.isFiltered || ((_a3 = metadata == null ? void 0 : metadata[index]) == null ? void 0 : _a3.tag) !== void 0;
      ...
      delete(index, operation, allChangesIndex = index) {
        ...
        if (previousValue && previousValue[$changes]) {
          (_a3 = this.root) == null ? void 0 : _a3.remove(previousValue[$changes]);
        }
        if (this.filteredChanges !== void 0) {
      ...
      endEncode(changeSetName) {
        ...
        (_b2 = (_a3 = this.ref)[$onEncodeEnd]) == null ? void 0 : _b2.call(_a3);
        this.isNew = false;
      }
    ...
    function encodeValue(encoder, bytes, type2, value, operation, it) {
      var _a3;
      if (typeof type2 === "string") {
        (_a3 = encode2[type2]) == null ? void 0 : _a3.call(encode2, bytes, value, it);
    ...
    const _ArraySchema = class _ArraySchema {
      ...
      static [(_a$4 = $encoder, _b$4 = $decoder, $filter)](ref, index, view2) {
        var _a3;
        return !view2 || typeof ref[$childType] === "string" || view2.isChangeTreeVisible((_a3 = ref["tmpItems"][index]) == null ? void 0 : _a3[$changes]);
      }
      static is(type2) {
        return (
          // type format: ["string"]
            ...
            if (typeof key !== "symbol" && !isNaN(key)) {
              if (setValue === void 0 || setValue === null) {
                ...
                if (setValue[$changes]) {
                  ...
                  if (previousValue !== void 0) {
                    (_a3 = previousValue[$changes].root) == null ? void 0 : _a3.remove(previousValue[$changes]);
                  }
                } else {
                  obj.$changeAt(Number(key), setValue);
                }
      ...
      push(...values) {
        ...
        for (let i = 0, l = values.length; i < l; i++, length++) {
          ...
          (_a3 = value[$changes]) == null ? void 0 : _a3.setParent(this, changeTree.root, length);
        }
        return length;
      }
      /**
      ...
      $changeAt(index, value) {
        ...
        (_a3 = value[$changes]) == null ? void 0 : _a3.setParent(this, changeTree.root, index);
      }
      // encoding only
      ...
      clear() {
        ...
        changeTree.forEachChild((childChangeTree, _) => {
          var _a3;
          (_a3 = changeTree.root) == null ? void 0 : _a3.remove(childChangeTree);
        });
      ...
      splice(start, deleteCount, ...insertItems) {
        ...
        if (insertCount > 0) {
          ...
          for (let i = 0; i < insertCount; i++) {
            ...
            (_a3 = insertItems[i][$changes]) == null ? void 0 : _a3.setParent(this, changeTree.root, addIndex);
          }
        }
    ...
    function view(tag = DEFAULT_VIEW_TAG) {
      return function(target2, fieldName) {
        ...
        const parentClass = Object.getPrototypeOf(constructor);
        const parentMetadata = parentClass[Symbol.metadata];
        const metadata = constructor[_a3 = Symbol.metadata] ?? (constructor[_a3] = Object.assign({}, constructor[Symbol.metadata], parentMetadata ?? /* @__PURE__ */ Object.create(null)));
...
Check @type() annotation`);
        ...
        set: function(value) {
          ...
          if (value !== void 0 && value !== null) {
            ...
            if (previousValue !== void 0 && previousValue[$changes]) {
              (_a3 = changeTree.root) == null ? void 0 : _a3.remove(previousValue[$changes]);
    ...
    const _Schema = class _Schema {
      ...
      static initialize(instance) {
        ...
        Object.defineProperties(instance, ((_a3 = instance.constructor[Symbol.metadata]) == null ? void 0 : _a3[$descriptors]) || {});
      }
      static is(type2) {
      ...
      static [$filter](ref, index, view2) {
        var _a3, _b2;
        const metadata = ref.constructor[Symbol.metadata];
        const tag = (_a3 = metadata[index]) == null ? void 0 : _a3.tag;
        if (view2 === void 0) {
          return tag === void 0;
        } else if (tag === void 0) {
          return true;
      ...
      clone() {
        ...
        for (const fieldIndex in metadata) {
          ...
          if (typeof this[field] === "object" && typeof ((_a3 = this[field]) == null ? void 0 : _a3.clone) === "function") {
      ...
      static debugRefIds(ref, showContents = false, level = 0) {
        ...
        const refCount = ((_b2 = (_a3 = changeTree.root) == null ? void 0 : _a3.refCount) == null ? void 0 : _b2[refId]) > 1 ? ` [×${changeTree.root.refCount[refId]}]` : "";
...
`;
      ...
      static debugChangesDeep(ref, changeSetName = "changes") {
        ...
        for (const [refId, changes] of Object.entries(root[changeSetName])) {
          ...
          let parentChangeTree = (_a3 = changeTree.parent) == null ? void 0 : _a3[$changes];
...
`;
    ...
    const _SetSchema = class _SetSchema {
       ...
       * - Then, the encoder iterates over all "owned" properties per instance and encodes them.
       */
      static [(_a2 = $encoder, _b = $decoder, $filter)](ref, index, view2) {
      ...
      add(value) {
        ...
        const operation = ((_a3 = this[$changes].indexes[index]) == null ? void 0 : _a3.op) ?? exports2.OPERATION.ADD;
        this[$changes].indexes[index] = index;
        this.$indexes.set(index, index);
        this.$items.set(index, value);
...
`);
      ...
      discardChanges() {
        ...
        if (length > 0) {
          while (length--) {
            (_a3 = this.root.changes[length]) == null ? void 0 : _a3.endEncode("changes");
          }
    ...
    class ReferenceTracker {
      ...
      removeCallback(refId, field, callback) {
        var _a3, _b2, _c;
        const index = (_c = (_b2 = (_a3 = this.callbacks) == null ? void 0 : _a3[refId]) == null ? void 0 : _b2[field]) == null ? void 0 : _c.indexOf(callback);
      ...
      decode(bytes, it = { offset: 0 }, ref = this.state) {
        ...
        while (it.offset < totalBytes) {
          if (bytes[it.offset] == SWITCH_TO_STRUCTURE) {
            ...
            (_a3 = ref[$onDecodeEnd]) == null ? void 0 : _a3.call(ref);
            ref = nextRef;
    ...
    class Reflection extends Schema {
      ...
      static decode(bytes, it) {
        ...
        reflection.types.forEach((reflectionType) => {
          ...
          const schema3 = class _ extends parentClass {
          };
    ...
    function getDecoderStateCallbacks(decoder2) {
      ...
      decoder2.triggerChanges = function(allChanges) {
        ...
        for (let i = 0, l = allChanges.length; i < l; i++) {
          ...
          if ((change.op & exports2.OPERATION.DELETE) === exports2.OPERATION.DELETE && change.previousValue instanceof Schema) {
            const deleteCallbacks = (_a3 = callbacks[$root.refIds.get(change.previousValue)]) == null ? void 0 : _a3[exports2.OPERATION.DELETE];
      ...
      function getProxy(metadataOrType, context) {
        var _a3;
        let metadata = ((_a3 = context.instance) == null ? void 0 : _a3.constructor[Symbol.metadata]) || metadataOrType;
        ...
        if (metadata && !isCollection) {
          ...
          return new Proxy({
            ...
            get(target2, prop) {
              ...
              if (metadataField) {
                const instance = (_a4 = context.instance) == null ? void 0 : _a4[prop];
    ...
    class StateView {
      ...
      add(obj, tag = DEFAULT_VIEW_TAG, checkIncludeParent = true) {
        ...
        if (tag !== DEFAULT_VIEW_TAG) {
          ...
          tags.add(tag);
          (_b2 = (_a3 = metadata == null ? void 0 : metadata[$fieldIndexesByViewTag]) == null ? void 0 : _a3[tag]) == null ? void 0 : _b2.forEach((index) => {
      ...
      addParentOf(childChangeTree, tag) {
        ...
        if (!this.visible.has(changeTree)) {
          this.visible.add(changeTree);
          const parentChangeTree = (_a3 = changeTree.parent) == null ? void 0 : _a3[$changes];
      ...
      remove(obj, tag = DEFAULT_VIEW_TAG, _isClear = false) {
        ...
        if (tag === DEFAULT_VIEW_TAG) {
          ...
          if (!Metadata.isValidInstance(parent) && changeTree.isFiltered) {
            ...
            (_a3 = metadata == null ? void 0 : metadata[$viewFieldIndexes]) == null ? void 0 : _a3.forEach((index) => changes[index] = exports2.OPERATION.DELETE);
          }
        } else {
      ...
      hasTag(ob, tag = DEFAULT_VIEW_TAG) {
        var _a3;
        const tags = (_a3 = this.tags) == null ? void 0 : _a3.get(ob[$changes]);
...
var WebSocketTransport2 = WebSocketTransport$2;
  ...
  constructor(protocol) {
    ...
    switch (protocol) {
      case "h3":
        ...
        break;
      default:
        this.transport = new WebSocketTransport2.WebSocketTransport(this.events);
        break;
    }
  }
  connect(url, options) {
...
const createNanoEvents = () => ({
  ...
  on(event, cb) {
    var _a2;
    ((_a2 = this.events[event]) === null || _a2 === void 0 ? void 0 : _a2.push(cb)) || (this.events[event] = [cb]);
    return () => {
      var _a3;
      this.events[event] = (_a3 = this.events[event]) === null || _a3 === void 0 ? void 0 : _a3.filter((i) => cb !== i);
    };
  }
});
...
let SchemaSerializer$1 = class SchemaSerializer {
...
let Room$1 = class Room {
  constructor(name, rootSchema) {
    ...
    this.onError((code, message) => {
      var _a2;
      return (_a2 = console.warn) === null || _a2 === void 0 ? void 0 : _a2.call(console, `colyseus.js - onError => (${code}) ${message}`);
    });
    this.onLeave(() => this.removeAllListeners());
  }
  connect(endpoint, devModeCloseCallback, room = this, options, headers) {
    const connection = new Connection2.Connection(options.protocol);
    room.connection = connection;
    connection.events.onmessage = Room.prototype.onMessageCallback.bind(room);
    connection.events.onclose = function(e) {
      var _a2;
      if (!room.hasJoined) {
        (_a2 = console.warn) === null || _a2 === void 0 ? void 0 : _a2.call(console, `Room connection was closed unexpectedly (${e.code}): ${e.reason}`);
    ...
    connection.events.onerror = function(e) {
      var _a2;
      (_a2 = console.warn) === null || _a2 === void 0 ? void 0 : _a2.call(console, `Room, onError (${e.code}): ${e.reason}`);
      room.onError.invoke(e.code, e.reason);
    };
  ...
  removeAllListeners() {
    ...
    if (this.serializer instanceof SchemaSerializer2.SchemaSerializer) {
  ...
  dispatchMessage(type, message) {
    ...
    if (this.onMessageHandlers.events[messageType]) {
      ...
      (_a2 = console.warn) === null || _a2 === void 0 ? void 0 : _a2.call(console, `colyseus.js: onMessage() not registered for type '${type}'.`);
    }
  }
  destroy() {
    if (this.serializer) {
...
let HTTP$1 = class HTTP {
  ...
  request(method, path, options = {}) {
    return httpie__namespace[method](this.client["getHttpEndpoint"](path), this.getOptions(options)).catch((e) => {
      ...
      const message = ((_a2 = e.data) === null || _a2 === void 0 ? void 0 : _a2.error) || e.statusMessage || e.message;
      if (!status && !message) {
        throw e;
      }
...
function discordURLBuilder(url) {
  var _a2;
  const localHostname = ((_a2 = window === null || window === void 0 ? void 0 : window.location) === null || _a2 === void 0 ? void 0 : _a2.hostname) || "localhost";
...
class Client {
  constructor(settings = DEFAULT_ENDPOINT, options) {
    ...
    this.http = new HTTP2.HTTP(this, (options === null || options === void 0 ? void 0 : options.headers) || {});
    this.auth = new Auth2.Auth(this.http);
  ...
  createRoom(roomName, rootSchema) {
    return new Room2.Room(roomName, rootSchema);
  }
...
(function(exports) {
  ...
  var SchemaSerializer3 = SchemaSerializer$2;
  var NoneSerializer2 = NoneSerializer$1;
  var Serializer2 = Serializer$1;
  Serializer2.registerSerializer("schema", SchemaSerializer3.SchemaSerializer);
  ...
  exports.Room = Room3.Room;
  exports.Auth = Auth3.Auth;
  exports.ServerError = ServerError2.ServerError;
  exports.SchemaSerializer = SchemaSerializer3.SchemaSerializer;
  exports.getStateCallbacks = SchemaSerializer3.getStateCallbacks;
      ...
      discard(discardAll = false) {
        ...
        if (discardAll) {
          ...
          this.forEachChild((changeTree, _) => {
            var _a4;
            return (_a4 = this.root) == null ? void 0 : _a4.remove(changeTree);
          });
        }
      }
      /**
...
const _CardInstanceSchema = class _CardInstanceSchema2 extends umdExports.Schema {
  constructor() {
    super(...arguments);
    this.instanceId = "";
    this.cardId = "";
  ...
  static fromCardData(data, instanceId) {
    const card = new _CardInstanceSchema2();
...
class PlayerState extends umdExports.Schema {
  constructor() {
    super(...arguments);
    this.sessionId = "";
...
class GameState extends umdExports.Schema {
  constructor() {
    super(...arguments);
...
class Boot extends phaserExports.Scene {
  constructor() {
    super("Boot");
  }
  preload() {
...
class Game extends phaserExports.Scene {
  constructor() {
    super("Game");
...
class MainMenu extends phaserExports.Scene {
  constructor() {
    super("MainMenu");
...
class Preloader extends phaserExports.Scene {
  constructor() {
    super("Preloader");
  }
  init() {
...
class Background extends phaserExports.Scene {
  constructor() {
    super("background");
  }
  create() {
...
class Lobby extends phaserExports.Scene {
  constructor() {
    super("Lobby");
  ...
  create() {
    ...
    this.readyButton.on("pointerdown", () => {
      var _a2;
      if (colyseusRoom && ((_a2 = this.readyButton.input) == null ? void 0 : _a2.enabled)) {
    ...
    this.readyButton.on("pointerover", () => {
      var _a2;
      if ((_a2 = this.readyButton.input) == null ? void 0 : _a2.enabled) this.readyButton.setColor("#55ff55");
    });
    this.readyButton.on("pointerout", () => {
      var _a2;
      if ((_a2 = this.readyButton.input) == null ? void 0 : _a2.enabled) this.readyButton.setColor("#00ff00");
  ...
  addPlayerStateListener(player, sessionId) {
    ...
    const $ = cjs.getStateCallbacks(colyseusRoom);
    (_a2 = this.playerStateListeners.get(sessionId)) == null ? void 0 : _a2();
  ...
  shutdown() {
    ...
    this.listenersAttached = false;
    (_a2 = this.phaseListenerUnsub) == null ? void 0 : _a2.call(this);
...
class Shop extends phaserExports.Scene {
  constructor() {
    super("Shop");
  ...
  create() {
    var _a2;
    this.scene.launch("background");
    if (!((_a2 = this.scene.get("BoardView")) == null ? void 0 : _a2.scene.isActive())) {
    ...
    this.refreshButton.on("pointerover", () => {
      var _a3;
      if ((_a3 = this.refreshButton.input) == null ? void 0 : _a3.enabled) {
    ...
    this.continueButton.on("pointerover", () => {
      var _a3;
      if ((_a3 = this.continueButton.input) == null ? void 0 : _a3.enabled)
  ...
  createShopCardsDisplay(centerX, centerY, gameWidth) {
    var _a2;
    (_a2 = this.shopOffersContainer) == null ? void 0 : _a2.destroy();
    ...
    shopOfferIds.forEach((cardId, index) => {
      ...
      cardContainer.off("pointerdown").on("pointerdown", (pointer) => {
        var _a3;
        if (!((_a3 = cardContainer.input) == null ? void 0 : _a3.enabled)) return;
    ...
    this.input.on(
      ...
      (pointer, gameObject) => {
        ...
        if (!(gameObject instanceof Phaser.GameObjects.Container) || !this.shopCardObjects.includes(gameObject))
          return;
        if (!((_a2 = gameObject.input) == null ? void 0 : _a2.enabled)) return;
    ...
    this.listeners.push(
      $(colyseusRoom.state.players).onAdd((player, sessionId) => {
        ...
        if (this.playerStateListenersUnsub.has(sessionId)) {
          (_a2 = this.playerStateListenersUnsub.get(sessionId)) == null ? void 0 : _a2();
        }
        const unsub = $(player).listen("isReady", () => {
          if (this.scene.isActive()) this.updateWaitingStatus();
        });
  ...
  shutdown() {
    ...
    this.shopCardObjects.forEach((obj) => obj.destroy());
    this.shopCardObjects = [];
    (_a2 = this.continueButton) == null ? void 0 : _a2.destroy();
...
class Preparation extends phaserExports.Scene {
  constructor() {
    super("Preparation");
  ...
  cleanupListeners() {
    ...
    (_a2 = this.playerStateListenerUnsub) == null ? void 0 : _a2.call(this);
  ...
  makeLocalPlayerCardsDraggable() {
    ...
    const processCards = (collection, area) => {
  ...
  shutdown() {
    ...
    this.cleanupListeners();
    (_a2 = this.startBattleButton) == null ? void 0 : _a2.destroy();
    (_b = this.waitingText) == null ? void 0 : _b.destroy();
    this.clientSideCardLayout.clear();
    this.events.off(Phaser.Scenes.Events.SHUTDOWN, this.shutdown, this);
  }
}
class Battle extends phaserExports.Scene {
  ...
  cleanupListeners() {
    ...
    (_a2 = this.phaseListenerUnsubscribe) == null ? void 0 : _a2.call(this);
  ...
  handleBattleEnd() {
    ...
    if ((_a2 = this.resultText) == null ? void 0 : _a2.active) {
  ...
  shutdown() {
    ...
    (_a2 = this.resultText) == null ? void 0 : _a2.destroy();
...
class BoardView extends phaserExports.Scene {
  ...
  setupColyseusListeners() {
    ...
    this.listeners.push(
      $(colyseusRoom.state).listen("currentPhase", (newPhase, oldPhase) => {
        ...
        const processCardVisualsPostBattle = (cardContainer, cardSchema, ownerSessionId, slotKey) => {
        ...
        this.playerVisuals.forEach((playerData, playerId) => {
          playerData.battlefield.forEach((cardContainer, slotKey) => {
            var _a2;
            const cardSchema = (_a2 = colyseusRoom == null ? void 0 : colyseusRoom.state.players.get(playerId)) == null ? void 0 : _a2.battlefield.get(slotKey);
          ...
          playerData.hand.forEach((cardContainer, slotKey) => {
            var _a2;
            const cardSchema = (_a2 = colyseusRoom == null ? void 0 : colyseusRoom.state.players.get(playerId)) == null ? void 0 : _a2.hand.get(slotKey);
            if (oldPhase === Phase.Battle || oldPhase === Phase.BattleEnd) {
              if (newPhase !== Phase.Battle && newPhase !== Phase.BattleEnd) {
                if (cardSchema && cardSchema.currentHp > 0) {
                  cardContainer.setAlpha(1);
  ...
  cleanupListeners() {
    ...
    (_a2 = this.playerHealthText) == null ? void 0 : _a2.destroy();
